package user.data.dynamodb.repository;
...
import user.data.repositories.ProductInfoRepository;
import user.data.dynamodb.repository.rule.LocalDbCreationRule;
...
public class ProductInfoRepositoryIntegrationTest {
    ...
    public void givenItemWithExpectedCost_whenRunFindAll_thenItemIsFound() {
        ...
        User user = new User(EXPECTED_COST, EXPECTED_PRICE);
